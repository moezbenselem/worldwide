...
class ListCastawayScreen extends StatefulWidget {
  const ListCastawayScreen({Key? key}) : super(key: key);

  @override
  _ListCastawayScreenState createState() => _ListCastawayScreenState();
}

class _ListCastawayScreenState extends State<ListCastawayScreen> {
  List<Castaway>? listCastaways;
    ...
    return Stack(
      ...
      children: [
        Padding(
          ...
          child: FutureBuilder(
            future: CastAwayDatabase.instance.readAllcastAway(),
            builder: (context, AsyncSnapshot snapshot) {
              if (!snapshot.hasData) {
                return Center(child: CircularProgressIndicator());
              } else if (snapshot.hasData) {
                listCastaways = snapshot.data;
                          ...
                          FocusedMenuItem(
                              ...
                              onPressed: () {
                                CastAwayDatabase.instance
                                    .deleteCastaway(snapshot.data[index].id);
        ...
        Positioned(
          ...
          child: FloatingActionButton(
            onPressed: () {
              castawayDialog(context, LocaleKeys.add_saver_text.tr(),
